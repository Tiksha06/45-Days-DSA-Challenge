# 📊 My 45-Days DSA Challenge Tracker

## 📑 Program Index Table

| Day | Topic | Problem Name | Folder / Code Link | Status |
| :---: | :--- | :--- | :--- | :---: |
| **Day 1-28** | Dynamic Tracking | *Day 1 to Day 28 problem lists will be updated here in parts over the next 3 days.* | *[Awaiting Manual Verification]* | 🔄 |
| **Day 29** | Strings & Trie | Reverse Words in a String | [View Code](./06-Strings_and_Trie/reverse-words-in-a-string) | ✅ |
| | | Longest Palindromic Substring | [View Code](./06-Strings_and_Trie/longest-palindromic-substring) | ✅ |
| | | Roman to Integer | [View Code](./06-Strings_and_Trie/roman-to-integer) | ✅ |
...
| | | Count and Say | [View Code](./06-Strings_and_Trie/count-and-say) | ✅ |
| | Trees & Graphs | Compare Version Numbers | [View Code](./06-Strings_and_Trie/compare-version-numbers) | ✅ |
| **Day 33** | Trees & Graphs | Standard Inorder Traversal | [View Code](./07-Trees_Graphs_and_DP/standard-inorder-traversal) | ✅ |
| | | Binary Tree Preorder Traversal | [View Code](./07-Trees_Graphs_and_DP/binary-tree-preorder-traversal) | ✅ |
| | | Binary Tree Postorder Traversal | [View Code](./07-Trees_Graphs_and_DP/binary-tree-postorder-traversal) | ✅ |
| | | Morris Inorder Traversal | [View Code](./07-Trees_Graphs_and_DP/morris-inorder-traversal) | ✅ |
| **Day 34** | Trees & Graphs | Morris Preorder Traversal | [View Code](./07-Trees_Graphs_and_DP/morris-preorder-traversal) | ✅ |
| | | Right/Left View of BT | [View Code](./07-Trees_Graphs_and_DP/binary-tree-right-side-view) | ✅ |
| | | Bottom View of BT | [View Code](./07-Trees_Graphs_and_DP/bottom-view-of-binary-tree) | ✅ |
| | | Top View of BT | [View Code](./07-Trees_Graphs_and_DP/top-view-of-binary-tree) | ✅ |
| **Day 35** | Trees & Graphs | Pre, Post, Inorder in One Traversal | [View Code](./07-Trees_Graphs_and_DP/pre-post-inorder-in-one-traversal) | ✅ |
| | | Vertical Order Traversal | [View Code](./07-Trees_Graphs_and_DP/vertical-order-traversal-of-a-binary-tree) | ✅ |
| | | Print Root to Leaf Path in BT | [View Code](./07-Trees_Graphs_and_DP/print-root-to-leaf-path-in-bt) | ✅ |
| | | Maximum Width of BT | [View Code](./07-Trees_Graphs_and_DP/maximum-width-of-binary-tree) | ✅ |
| **Day 36** | Trees & Graphs | Level Order Traversal | [View Code](./07-Trees_Graphs_and_DP/binary-tree-level-order-traversal) | ✅ |
